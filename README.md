...
- **Spec 101 — Bloatgaurd budgets**: `focusa_bloatgaurd_report` and `focusa_bloatgaurd_domain` expose read-only budget domains 5.1–5.8 across Rust/API/CLI/Pi/menubar surfaces. See `docs/101-focusa-bloatgaurd-spec.md`, `docs/focusa-tools/tools/focusa_bloatgaurd_report.md`, and `docs/focusa-tools/tools/focusa_bloatgaurd_domain.md`.
