...
- **Anti-false-claim gate**: `focusa_claim_preclose_gate` and `focusa claim preclose` classify evidence as actual/partial/blocked/missing and block completion overclaims before bead close or final reports. See `docs/focusa-tools/tools/focusa_claim_preclose_gate.md`.
