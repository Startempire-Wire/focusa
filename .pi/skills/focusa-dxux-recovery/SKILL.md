...
description: Use for blocked/degraded explanation, executable recovery, and operator-facing failure envelopes.
---
# focusa-dxux-recovery

## Trigger
Use when the request directly concerns blocked/degraded explanation, executable recovery, and operator-facing failure envelopes.
