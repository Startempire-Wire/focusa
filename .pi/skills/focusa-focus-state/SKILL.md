...
description: Use for operator journal decisions, constraints, failures, frame slots, and non-destructive hygiene.
---
# focusa-focus-state

## Trigger
Use when the request directly concerns operator journal decisions, constraints, failures, frame slots, and non-destructive hygiene.
