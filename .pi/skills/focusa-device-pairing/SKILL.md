...
description: "Use for device pairing authority, routing, evidence, and recovery."
---

# Focusa Device Pairing

Use for device pairing authority, routing, evidence, and recovery.

## Progressive disclosure

1. Load this core file only when its trigger matches.
2. Read `references/01-focusa-device-pairing-runbook.md` only for the selected workflow.
...
- device pairing authority, routing, evidence, and recovery
...
2. `focusa_device_pair_qr`
3. `focusa_device_pair_complete`
4. `focusa_device_pair_status`
5. `focusa_device_pair_list`
6. `focusa_device_pair_revoke`
