...
description: Use for bounded cognition packets, proof rendering, curation, eval, optimization, and token budgets.
---
# focusa-context-cognition

## Trigger
Use when the request directly concerns bounded cognition packets, proof rendering, curation, eval, optimization, and token budgets.
