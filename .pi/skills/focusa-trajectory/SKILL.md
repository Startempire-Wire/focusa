...
description: Use for HLT, goal hierarchy, desired state, gaps, Waypoints, supersession, and Workpoint proposals.
---
# focusa-trajectory

## Trigger
Use when the request directly concerns HLT, goal hierarchy, desired state, gaps, Waypoints, supersession, and Workpoint proposals.
