---
name: focusa-lineage
description: Use for tree head/path, snapshots, compare, restore, and bounded lineage extraction.
---
# focusa-lineage

## Trigger
Use when the request directly concerns tree head/path, snapshots, compare, restore, and bounded lineage extraction.
