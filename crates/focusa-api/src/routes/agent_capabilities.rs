...
fn build_operations() -> Vec<OperationEntry> {
    vec![
        ...
        // ── background jobs (#311-family) ──────────────────────────────────
        op(
            "focusa.background.jobs",
            "Background Jobs",
            "background",
            "GET",
            "/v1/background-jobs",
            ...
            "light_read",
            vec!["compact", "standard"],
            "focusa.background_job.v1",
            "focusa.background_job.v1",
            "docs/focusa-tools/tools/focusa_bg_status.md",
            None,
        ),
        op(
            "focusa.runtime.constitution",
            ...
            "light_read",
            vec!["compact"],
            "focusa.runtime_constitution.v1",
            "focusa.runtime_constitution.v1",
            "docs/focusa-tools/tools/focusa_agent_card.md",
            None,
        ),
        op(
            "focusa.completion.claims.evaluate",
            "Completion Claim Evaluate",
            "completion",
            "POST",
            ...
            "light_read",
            vec!["compact"],
            "focusa.completion_claim.v1",
            "focusa.completion_verdict.v1",
            "docs/focusa-tools/tools/focusa_bg_status.md",
            None,
        ),
        op(
        ...
        op(
            ...
            "light_read",
            vec!["compact"],
            "focusa.direction_operation.v1",
            "focusa.direction_receipt.v1",
            "docs/166-direction-workbench-and-proof-adjudication-design.md",
            None,
        ),
        op(
            "focusa.silent.fanout",
            "Silent Session Fanout",
            "orchestration",
            "POST",
            ...
            "light_read",
            vec!["compact"],
            "focusa.session_fanout.v1",
            "focusa.session_fanout.v1",
            "docs/169-fast-forward-session-multiplier-design.md",
            None,
        ),
        op(
            "focusa.adapters.registry",
            "Adapter Registry",
            "adapters",
            "GET",
            "/v1/adapters",
