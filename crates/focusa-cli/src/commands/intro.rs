...
\x20\x20\x20\u{db}\u{db}\u{db}\x20\u{db}\u{db}\u{db}\u{db}\u{db}\x20\x20\x20\u{db}\u{db}\u{db}\u{db}\x20\u{db}\u{db}\u{db}\u{db}\x20\u{db}\u{db}\u{db}\n\
\x20\u{db}\u{db}\x20\x20\u{db}\x20\u{db}\x20\x20\x20\u{db}\x20\x20\x20\x20\x20\u{db}\x20\u{db}\x20\x20\x20\u{db}\x20\u{db}\u{db}\x20\n\
\x20\u{db}\u{db}\u{db}\u{db}\u{db}\u{db}\u{db}\x20\x20\u{db}\u{db}\u{db}\u{db}\x20\u{db}\u{db}\x20\u{db}\u{db}\u{db}\x20\u{db}\u{db}\u{db}\x20\u{db}\x20\n\
\x20\u{db}\u{db}\x20\x20\u{db}\x20\u{db}\u{db}\u{db}\u{db}\u{db}\x20\u{db}\x20\x20\x20\u{db}\x20\u{db}\u{db}\u{db}\u{db}\x20\u{db}\u{db}\x20\n\
