...
<style>
  ...
  .work-grid{display:grid;grid-template-columns:1.25fr .75fr;gap:8px}.panel-title{display:flex;justify-content:space-between;color:#abb9cd;font-size:9px}.panel-title small{color:#617187}.code-lines{display:grid;gap:8px;margin-top:16px;font:10px ui-monospace,SFMono-Regular,Menlo,monospace;color:#83dcae}.code-lines em{display:inline-block;width:25px;color:#47596d;font-style:normal}.code-lines b{display:inline-flex;vertical-align:middle;color:var(--color-violet)}.transcript-panel p{margin-top:18px;color:#77879d;font-size:10px;line-height:1.6}
