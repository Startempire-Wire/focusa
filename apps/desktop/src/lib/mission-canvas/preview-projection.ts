...
import populatedProjection from '../../../tests/fixtures/mission-canvas/populated-projection.json';
...
export const DESKTOP_BROWSER_PREVIEW_PROJECTIONS: Readonly<Record<string, ResolvedWorkspaceProjection>> = {
  ...
  'mission-deck': populatedProjection as ResolvedWorkspaceProjection,
