...
const AGENT_RUNTIME_TOOL_CONTRACTS: FocusaToolContract[] = [
  ...
  ["focusa_instruction_integrity_evaluate", "Instruction Integrity Evaluate", "instruction.integrity_evaluate", "POST /v1/agent-runtime/instruction-integrity/evaluate", "focusa agent-runtime integrity-evaluate", true],
  ["focusa_instruction_integrity_status", "Instruction Integrity Status", "instruction.integrity_status", "GET /v1/agent-runtime/instruction-integrity/status", "focusa agent-runtime integrity-status", false],
  ["focusa_canonical_instruction_amendment_propose", "Canonical Instruction Amendment Propose", "instruction.amendment_propose", "POST /v1/agent-runtime/amendments/propose", "focusa agent-runtime amendment-propose", true],
  ["focusa_canonical_instruction_amendment_activate", "Canonical Instruction Amendment Activate", "instruction.amendment_activate", "POST /v1/agent-runtime/amendments/activate", "focusa agent-runtime amendment-activate", true],
  ["focusa_agent_runtime_headless_verify", "Agent Runtime Headless Verify", "instruction.headless_verify", "POST /v1/agent-runtime/headless/verify", "focusa agent-runtime headless-verify", true],
...
const TOOL_NEXT_TOOLS: Record<string, string[]> = {
  focusa_agent_runtime_effective: ["focusa_instruction_sources", "focusa_instruction_conflicts", "focusa_instruction_integrity_status"],
  focusa_instruction_sources: ["focusa_instruction_conflicts", "focusa_instruction_explain", "focusa_agent_runtime_effective"],
  focusa_instruction_conflicts: ["focusa_instruction_explain", "focusa_instruction_simulate", "focusa_instruction_integrity_evaluate"],
  focusa_instruction_explain: ["focusa_instruction_simulate", "focusa_agent_runtime_effective"],
  focusa_instruction_simulate: ["focusa_runtime_constitution_preview", "focusa_instruction_integrity_evaluate"],
  ...
  focusa_instruction_integrity_evaluate: ["focusa_instruction_integrity_status", "focusa_agent_runtime_headless_verify"],
  focusa_instruction_integrity_status: ["focusa_instruction_integrity_evaluate", "focusa_agent_runtime_doctor"],
  focusa_canonical_instruction_amendment_propose: ["focusa_canonical_instruction_amendment_activate", "focusa_instruction_integrity_evaluate"],
  focusa_canonical_instruction_amendment_activate: ["focusa_instruction_integrity_evaluate", "focusa_agent_runtime_effective"],
  focusa_agent_runtime_headless_verify: ["focusa_instruction_integrity_status", "focusa_agent_runtime_doctor"],
