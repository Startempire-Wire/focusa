...
export const FOCUSA_TOOL_CONTRACTS: FocusaToolContract[] = [
  ...
  },
  {
    ...
    purpose: "List bounded agent preload profiles.",
    family: "preload",
    ontology_action: "preload.profiles",
    ontology_objects: ["ScopedCapabilityRecord"],
    api_routes: ["GET /v1/preload/profiles"],
    cli_commands: [],
    core_surface: "Scoped Focusa authority",
    doc_path: "docs/focusa-tools/tools/focusa_preload_profiles.md",
    result_envelope: "tool_result_v1",
    side_effect_profile: "read_state",
    parity_status: "full",
    exemptions: [],
  ...
  },
  {
    ...
    label: "Write Preload",
    purpose: "Write an idempotent preload packet to an allowlisted target.",
    family: "preload",
    ontology_action: "preload.write",
    ontology_objects: ["ScopedCapabilityRecord"],
    api_routes: ["POST /v1/preload/write"],
    cli_commands: [],
    core_surface: "Scoped Focusa authority",
    doc_path: "docs/focusa-tools/tools/focusa_preload_write.md",
    result_envelope: "tool_result_v1",
    side_effect_profile: "write_preload",
    parity_status: "full",
    exemptions: [],
    live_check: "contract_static plus scoped API smoke test",
    scope_requirement: { kind: "read", route_family: "auto" },
  ...
  },
  {
    ...
    purpose: "Preview bootstrap delivery receipt without mutation.",
    family: "preload",
    ontology_action: "preload.receipt.preview",
    ontology_objects: ["ScopedCapabilityRecord"],
    api_routes: ["POST /v1/preload/receipt-preview"],
    cli_commands: [],
    core_surface: "Scoped Focusa authority",
    doc_path: "docs/focusa-tools/tools/focusa_preload_receipt_preview.md",
    result_envelope: "tool_result_v1",
    side_effect_profile: "read_state",
    parity_status: "full",
    exemptions: [],
  ...
  },
  {
    ...
    purpose: "Commit an idempotent bootstrap delivery receipt.",
    family: "preload",
    ontology_action: "preload.receipt.commit",
    ontology_objects: ["ScopedCapabilityRecord"],
    api_routes: ["POST /v1/preload/receipt-commit"],
    cli_commands: [],
    core_surface: "Scoped Focusa authority",
    doc_path: "docs/focusa-tools/tools/focusa_preload_receipt_commit.md",
    result_envelope: "tool_result_v1",
  ...
  },
  {
    ...
    ontology_objects: ["ScopedCapabilityRecord"],
    api_routes: ["POST /v1/prediction-authority/events|projection"],
    cli_commands: [],
    core_surface: "Scoped Focusa authority",
