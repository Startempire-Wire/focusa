...
export const FOCUSA_TOOL_CONTRACTS: FocusaToolContract[] = ([
  ...
  },
  {
    ...
    purpose: "Inspect the fail-closed Project → HLT → MLG → STG → Workpoint → frontier chain with Short, Medium, or Full canonical Workset, CallGraph, evidence, and unresolved-scope projection.",
    family: "trajectory",
    ontology_action: "north_star.inspect",
    ontology_objects: ["ProjectIdentity", "Trajectory", "Workpoint"],
    api_routes: ["GET /v1/project/north-star-gate"],
    cli_commands: ["focusa project north-star"],
    core_surface: "Daemon-owned continuous north-star authority gate",
    ...
    parity_status: "full",
    exemptions: [],
    live_check: "daemon route plus CLI/Pi north-star gate tests and lifecycle transition projection",
    scope_requirement: { kind: "read", route_family: "project" },
    authority_requirement: { kind: "canonical", path: "/v1/project/north-star-gate" },
  },
  {
