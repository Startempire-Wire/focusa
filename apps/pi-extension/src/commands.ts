  ...
  pi.registerCommand("focusa-settings", {
    ...
    handler: async (args, ctx) => {
      ...
      const draft = {
        ...
        vitalInfoPromptSurfaces: S.cfg?.vitalInfoPromptSurfaces || "project_root,workpoint,trajectory",
      ...
      const buildSimpleItems = (): SettingItem[] => [
        ...
        { id: "vitalInfoPromptSurfaces", label: "Vital prompt surfaces", currentValue: draft.vitalInfoPromptSurfaces, values: ["project_root,workpoint,trajectory", "project_root", "project_root,workpoint", "project_root,trajectory"] },
      ...
      const buildAdvancedItems = (): SettingItem[] => [
        ...
        { id: "vitalInfoPromptMode", label: "Vital project info prompt", currentValue: draft.vitalInfoPromptMode, values: VITAL_INFO_PROMPT_MODE_OPTIONS },
        { id: "vitalInfoPromptSurfaces", label: "Vital prompt surfaces", currentValue: draft.vitalInfoPromptSurfaces, values: ["project_root,workpoint,trajectory", "project_root", "project_root,workpoint", "project_root,trajectory", "project_root,workpoint,trajectory,evidence,active_object,resource_mode"] },
