...
```text
focusa_work_loop_checkpoint -> focusa_work_loop_context
focusa_work_loop_context -> focusa_work_loop_control
focusa_work_loop_control -> focusa_work_loop_select_next
focusa_work_loop_select_next -> focusa_work_loop_status
focusa_work_loop_status -> focusa_work_loop_writer_status
```

## Minimal path

1. Call `focusa_work_loop_checkpoint` with only required bounded inputs.
2. Call `focusa_work_loop_context` with only required bounded inputs.
3. Call `focusa_work_loop_control` with only required bounded inputs.
4. Call `focusa_work_loop_select_next` with only required bounded inputs.
5. Call `focusa_work_loop_status` with only required bounded inputs.
6. Call `focusa_work_loop_writer_status` with only required bounded inputs.
