---
name: focusa-context-cognition
description: "Use for context cognition authority, routing, evidence, and recovery."
---

# Focusa Context Cognition

Use for context cognition authority, routing, evidence, and recovery.

## Progressive disclosure

1. Load this core file only when its trigger matches.
2. Read `references/01-focusa-context-cognition-runbook.md` only for the selected workflow.
...
- context cognition authority, routing, evidence, and recovery
...
1. `focusa_context_cognition`
2. `focusa_context_cognition_render`
3. `focusa_context_cognition_proof`
4. `focusa_context_cognition_curate`
5. `focusa_context_cognition_curate_eval`
6. `focusa_context_cognition_curate_optimize`
7. `focusa_context_cognition_optimizer_artifacts`
...
- workflow: `focusa-project-scope` → `focusa-context-cognition` → `focusa-workpoint` → `focusa-evidence-outcomes`
