---
name: focusa-lineage
description: "Use for lineage authority, routing, evidence, and recovery."
---

# Focusa Lineage

Use for lineage authority, routing, evidence, and recovery.

## Progressive disclosure

1. Load this core file only when its trigger matches.
2. Read `references/01-focusa-lineage-runbook.md` only for the selected workflow.
...
- lineage authority, routing, evidence, and recovery
...
6. `focusa_lineage_tree`
7. `focusa_li_tree_extract`
...
- workflow: `focusa-project-scope` → `focusa-lineage` → `focusa-workpoint` → `focusa-evidence-outcomes`
