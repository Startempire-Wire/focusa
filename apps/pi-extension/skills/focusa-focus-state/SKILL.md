---
name: focusa-focus-state
description: "Use for focus state authority, routing, evidence, and recovery."
---

# Focusa Focus State

Use for focus state authority, routing, evidence, and recovery.

## Progressive disclosure

1. Load this core file only when its trigger matches.
2. Read `references/01-focusa-focus-state-runbook.md` only for the selected workflow.
...
- focus state authority, routing, evidence, and recovery
...
3. `focusa_failure`
4. `focusa_intent`
5. `focusa_current_focus`
6. `focusa_next_step`
7. `focusa_open_question`
8. `focusa_recent_result`
9. `focusa_note`
10. `focusa_state_hygiene_doctor`
...
- workflow: `focusa-project-scope` → `focusa-focus-state` → `focusa-workpoint` → `focusa-evidence-outcomes`
