...
SP=SD/"focusa.mission_canvas_state.v1.json"
CP=ROOT/"docs/contracts/spec135-canvas-layout-restoration.v1.json"
fields={
 "schema":{"const":"focusa.mission_canvas_state.v1"}, "canvas_id":{"type":"string","minLength":1}, "state_revision":{"type":"integer","minimum":1},
...
schema={"$schema":"https://json-schema.org/draft/2020-12/schema","$id":"https://docs.startempire.ai/focusa/spec135/focusa.mission_canvas_state.v1.json","title":"Focusa Mission Canvas State v1","description":"Per-user/device presentation state; never canonical project authority.","type":"object","required":required,"properties":fields,"additionalProperties":False}
