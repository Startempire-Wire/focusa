...
const required = ['Focusa Utility Card', 'adapter=openclaw', 'workspace=wirebot', '/v1/doctor', 'checkpoint a project-bound Workpoint', 'fetch Workpoint resume', 'capture or link evidence', 'record a prediction', 'cognition_degraded=true', 'Operator steering always wins'];
