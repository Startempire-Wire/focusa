...
run_gate ./tests/work_loop_bd_transition_wiring_test.sh
run_gate ./tests/work_loop_affordance_environment_surface_test.sh
run_gate ./tests/work_loop_affordance_consumer_path_test.sh
run_gate ./tests/work_loop_commitment_lifecycle_contract_test.sh
