...
def build(candidate_ref: str, audit_ref: str) -> dict:
    ...
    elif candidate_versions not in ({published_version}, {next_stable_version}, {f"{next_stable_version}-dev"}, {next_selection["selected_version"]}, {f"0.9.{next_selection['highest_patch']}-dev"}, {f"0.9.{next_selection['highest_patch']}"}):
