...
${RUNNER_USER} ALL=(root) NOPASSWD: /bin/bash ${RUNNER_ROOT}/_work/focusa/focusa/scripts/install-daemon.sh *, /bin/bash ${RUNNER_ROOT}/_work/focusa/focusa/scripts/safe-disk-cleanup.sh *, /usr/bin/systemctl start focusa-daemon.service, /usr/bin/systemctl stop focusa-daemon.service, /usr/bin/systemctl is-active focusa-daemon.service, /usr/bin/systemctl show focusa-daemon.service, /usr/bin/systemctl daemon-reload, /usr/bin/systemctl restart focusa-daemon.service, /usr/bin/kill, /usr/bin/install, /usr/bin/mv, /usr/bin/cp, /usr/bin/rm, /usr/bin/ln
EOF
