...
- Added marker-backed, repo-scanned, and WordPress/live-root scanned project environment/deploy facts to ProjectIdentity and Pi Focus Slice so agents see live/local URLs and deploy targets at a glance.
