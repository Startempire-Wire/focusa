...
- Reworded the missing active Pi frame fallback to `Attentive and awaiting operator direction` and surfaced it in the Utility Card so agents stay helpful while scratch fallback/recovery guidance remains available.
