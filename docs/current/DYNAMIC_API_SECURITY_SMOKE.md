...
7. Sends repeated mutation requests to verify route-scoped rate limiting returns HTTP `429`.
8. Sends a small burst of health requests to verify the daemon remains responsive after rejected inputs.
