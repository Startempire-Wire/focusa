...
| `focusa_silent_sessions` | `work_loop` | `work_loop.silent_session.control` | <em>exempt</em> | tmux list-sessions<br>tmux new-session<br>tmux attach-session<br>tmux kill-session | `pi_only` | [`doc`](../focusa-tools/tools/focusa_silent_sessions.md) |
