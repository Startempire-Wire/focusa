...
| `focusa_traverse` | `traversal` | `traverse.read` | POST /v1/traverse; POST /v1/traverse/verify-tags | surgical traversal facade | `domain` | [`doc`](../focusa-tools/tools/focusa_traverse.md) |
