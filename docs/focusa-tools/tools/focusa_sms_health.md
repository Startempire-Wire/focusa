...
- Read value-free connector and encrypted-checkpoint health.
...
Unknown object properties are rejected. Canonical schema: `agent-capability-descriptors.json#focusa_sms_health`.
...
Expected: Visible summary plus tool_result_v1 details; docs: docs/focusa-tools/tools/focusa_sms_health.md
...
- Pi: `focusa_sms_health`; MCP: `focusa.sms.health`; OpenAI: `focusa_sms_health`.
