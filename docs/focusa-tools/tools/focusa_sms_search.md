...
- Search separately authorized message scope with bounded results.
...
Expected: Visible summary plus tool_result_v1 details; docs: docs/focusa-tools/tools/focusa_sms_search.md
...
- `focusa_sms_read_thread` (likely_next)
...
- Pi: `focusa_sms_search`; MCP: `focusa.sms.search`; OpenAI: `focusa_sms_search`.
