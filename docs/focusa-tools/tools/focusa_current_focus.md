...
- `focus` (required; string): Current focus: what you are actively working on (1-3 sentences, max 300 chars).

Unknown object properties are rejected. Canonical schema: `agent-capability-descriptors.json#focusa_current_focus`.
...
Expected: Visible summary plus tool_result_v1 details; docs: docs/focusa-tools/tools/focusa_current_focus.md
...
- Pi: `focusa_current_focus`; MCP: `focusa.current.focus`; OpenAI: `focusa_current_focus`.
- CLI: `focusa focus update --current-focus`.
- REST: `POST /v1/focus/update`.
- Specification: contract registry.
- Descriptor digest: `sha256:10df70fb49839caef401215ff88b4060dbd790ff636d8fbdddf85a38c03b9d92`.
