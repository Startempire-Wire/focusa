...
- Spec105 — read compact continuation/doability digest.
...
Unknown object properties are rejected. Canonical schema: `agent-capability-descriptors.json#focusa_dxux_digest`.
...
Expected: Visible summary plus tool_result_v1 details; docs: docs/focusa-tools/tools/focusa_dxux_digest.md
...
- Pi: `focusa_dxux_digest`; MCP: `focusa.dxux.digest`; OpenAI: `focusa_dxux_digest`.
- CLI: `focusa dxux digest`.
- REST: `GET /v1/dxux/digest`.
- Assignable: `true`; parity: `full`.
- Specification: contract registry.
- Descriptor digest: `sha256:86be45d7dd7dcbd2b256749eb360523955644f71a0584715fcc04c2e1f572d8a`.
