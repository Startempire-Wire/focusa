...
- Spec 101 — read profile presets and operator switches.
...
Unknown object properties are rejected. Canonical schema: `agent-capability-descriptors.json#focusa_bloatgaurd_profiles`.
...
Expected: Visible summary plus tool_result_v1 details; docs: docs/focusa-tools/tools/focusa_bloatgaurd_profiles.md
...
- `focusa_bloatgaurd_profile` (likely_next)
...
- Descriptor digest: `sha256:25605e52fc9c91871f9472ba4025a1b520ea992c3e29be6b08b988530ac01241`.
