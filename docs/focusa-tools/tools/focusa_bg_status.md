...
- `job_id` (optional; string): Optional job id; omit to list recent jobs.

Unknown object properties are rejected. Canonical schema: `agent-capability-descriptors.json#focusa_bg_status`.
...
Expected: Visible summary plus tool_result_v1 details; docs: docs/focusa-tools/tools/focusa_bg_status.md
...
- Descriptor digest: `sha256:65db616af5a5efef2dff90f7de55ff374a7bd7584c07b7b31a2079a81140e7a0`.
