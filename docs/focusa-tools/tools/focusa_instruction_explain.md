...
- Operate the Spec 140 instruction explain surface with typed scope and evidence.
...
- `claim_id` (required; string): See the strict descriptor schema.
- `max_source_bytes` (optional; number; min=1): See the strict descriptor schema.

Unknown object properties are rejected. Canonical schema: `agent-capability-descriptors.json#focusa_instruction_explain`.
...
Expected: Visible summary plus tool_result_v1 details; docs: docs/focusa-tools/tools/focusa_instruction_explain.md
...
- Pi: `focusa_instruction_explain`; MCP: `focusa.instruction.explain`; OpenAI: `focusa_instruction_explain`.
...
- Descriptor digest: `sha256:91134ddb7b89bb0eb53aa70c3662293237aa8a26f114cf0d82062ee0e38678fb`.
