...
- Operate the Spec 140 prompt variant preview surface with typed scope and evidence.
...
Unknown object properties are rejected. Canonical schema: `agent-capability-descriptors.json#focusa_prompt_variant_preview`.
...
Expected: Visible summary plus tool_result_v1 details; docs: docs/focusa-tools/tools/focusa_prompt_variant_preview.md
...
- Descriptor digest: `sha256:db09b32ae44ed87571fca22f69c0442dc435e8e3827c2f305c7b817559a00350`.
