...
- Operate the Spec 140 instruction integrity evaluate surface with typed scope and evidence.
- Capability family: `agent_runtime`; namespace: `focusa.agent_runtime`.
- Load this full contract after metadata search when exact invocation or recovery semantics are needed.

## Parameters and strict input schema

- `request` (required; structured): Typed integrity event envelope.

Unknown object properties are rejected. Canonical schema: `agent-capability-descriptors.json#focusa_instruction_integrity_evaluate`.
...
Expected: Visible summary plus tool_result_v1 details; docs: docs/focusa-tools/tools/focusa_instruction_integrity_evaluate.md
...
- Pi: `focusa_instruction_integrity_evaluate`; MCP: `focusa.instruction.integrity.evaluate`; OpenAI: `focusa_instruction_integrity_evaluate`.
...
- Descriptor digest: `sha256:88d73b00dd8eaf1b0adedf7e2eb3bcc7d13f6e4973564ebb068213facbfe9fdc`.
