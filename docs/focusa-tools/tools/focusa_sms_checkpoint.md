...
- Create and verify an encrypted atomic connector checkpoint with value-free receipt metadata.
...
Expected: Visible summary plus tool_result_v1 details; docs: docs/focusa-tools/tools/focusa_sms_checkpoint.md
...
- Pi: `focusa_sms_checkpoint`; MCP: `focusa.sms.checkpoint`; OpenAI: `focusa_sms_checkpoint`.
