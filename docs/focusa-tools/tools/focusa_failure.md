...
- `failure` (required; string): Specific failure: what failed + diagnosis (max 300 chars). Must contain period or colon.
- `recovery` (optional; string): What was done to recover or workaround.

Unknown object properties are rejected. Canonical schema: `agent-capability-descriptors.json#focusa_failure`.
...
Expected: Visible summary plus tool_result_v1 details; docs: docs/focusa-tools/tools/focusa_failure.md
...
- Descriptor digest: `sha256:215ebcad233305ce8a2e9539f72689a80cf1cfeb0bb0de962403a3edd4ee703c`.
