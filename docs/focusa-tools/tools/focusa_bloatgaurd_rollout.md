...
- Spec 101 — read rollout phases, acceptance checks, and proof commands.
...
Unknown object properties are rejected. Canonical schema: `agent-capability-descriptors.json#focusa_bloatgaurd_rollout`.
...
Expected: Visible summary plus tool_result_v1 details; docs: docs/focusa-tools/tools/focusa_bloatgaurd_rollout.md
...
- Pi: `focusa_bloatgaurd_rollout`; MCP: `focusa.bloatgaurd.rollout`; OpenAI: `focusa_bloatgaurd_rollout`.
- CLI: `focusa bloatgaurd rollout`.
- REST: `GET /v1/bloatgaurd/rollout/report`.
- Specification: contract registry.
- Descriptor digest: `sha256:579b9378ae2d281d259ea13ab2d14f7dc349136cc113f21fe7e7055f0ea08be5`.
