...
- Operate the Spec 140 agent runtime doctor surface with typed scope and evidence.
...
Unknown object properties are rejected. Canonical schema: `agent-capability-descriptors.json#focusa_agent_runtime_doctor`.
...
Expected: Visible summary plus tool_result_v1 details; docs: docs/focusa-tools/tools/focusa_agent_runtime_doctor.md
...
- Pi: `focusa_agent_runtime_doctor`; MCP: `focusa.agent.runtime.doctor`; OpenAI: `focusa_agent_runtime_doctor`.
...
- Descriptor digest: `sha256:c8a4ad38c202dcebea44f75dc92c79025093868a29dd83440dd6aa793bd1a862`.
