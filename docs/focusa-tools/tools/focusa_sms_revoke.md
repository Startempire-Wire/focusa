...
- Revoke one customer-owned connector and all associated grants with explicit confirmation.
...
Expected: Visible summary plus tool_result_v1 details; docs: docs/focusa-tools/tools/focusa_sms_revoke.md
...
- Pi: `focusa_sms_revoke`; MCP: `focusa.sms.revoke`; OpenAI: `focusa_sms_revoke`.
