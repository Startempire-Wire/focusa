...
- Operate the Spec 140 runtime constitution preview surface with typed scope and evidence.
- Capability family: `agent_runtime`; namespace: `focusa.agent_runtime`.
- Load this full contract after metadata search when exact invocation or recovery semantics are needed.

## Parameters and strict input schema

- `constitution_id` (required; string): See the strict descriptor schema.
- `request` (required; structured): Typed PromptCompileInput request.

Unknown object properties are rejected. Canonical schema: `agent-capability-descriptors.json#focusa_runtime_constitution_preview`.
...
```json
{
  "constitution_id": "example",
  "request": {}
}
```

Expected: Visible summary plus tool_result_v1 details; docs: docs/focusa-tools/tools/focusa_runtime_constitution_preview.md
...
- Pi: `focusa_runtime_constitution_preview`; MCP: `focusa.runtime.constitution.preview`; OpenAI: `focusa_runtime_constitution_preview`.
...
- Descriptor digest: `sha256:658f660e5668fdc3b6e428275b581076b50412beb43db9efb9b5a670a349a1b4`.
