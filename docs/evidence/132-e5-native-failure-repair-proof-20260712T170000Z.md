...
3. Linux regression proof passed:
...
The native Windows ConPTY and macOS jobs must rerun on their hosted runners; E5 remains open until both return green. Release matrix and protected bootstrapper files were not changed.
