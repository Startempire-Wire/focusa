...
run_json tool_contracts '.contracts | length == 63' curl -fsS --max-time 8 http://127.0.0.1:8787/v1/ontology/tool-contracts
run_json tool_choreography '.schema == "focusa.tool_choreography.v1" and .tool_count == 63 and .edge_count >= 62 and (.per_tool_next_tools.focusa_project_identity | length > 0)' curl -fsS --max-time 8 http://127.0.0.1:8787/v1/ontology/tool-choreography
