...
verified_requirements = {
    *(f"SPEC135-F{i}" for i in range(13)),
    ...
    "SPEC135-M1", "SPEC135-M2", "SPEC135-M3", "SPEC135-M4", "SPEC135-M5", "SPEC135-M6",
...
m7 = next(r for r in requirements if r["requirement_id"] == "SPEC135-M7")
assert m7["current_status"] == "partial"
assert m7["closure_status"] == "open"
