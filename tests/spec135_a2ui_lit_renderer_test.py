...
catalog = json.loads((ROOT / "docs/contracts/spec135/generated-contract-v1/a2ui-catalog.json").read_text())
compatibility = json.loads((ROOT / "docs/contracts/spec135/generated-contract-v1/compatibility-lock.yaml").read_text())
...
for marker in (
    'from "@a2ui/web_core/v0_9"', 'from "@a2ui/lit/v0_9"',
    "class FocusaA2uiRenderer", "new MessageProcessor", "basicCatalog",
    'document.createElement("a2ui-surface")', "processSnapshot", "processDelta",
    "maxSerializedBytes", "Unsupported A2UI protocol version",
):
    assert marker in source
assert "A2UI v0.9.1 snapshot and delta render deterministically through Lit" in renderer_test
...
print("Spec 135 A2UI Lit renderer: PASS (v0.9.1 snapshot/delta, permanent bounded renderer)")
