...
assert ACCEPTANCE["status"] == "reopened"
assert ACCEPTANCE["passed_count"] == 2
assert ACCEPTANCE["gate_count"] == 14
assert ACCEPTANCE["merge_ready"] is False

print("Spec 135 P00 governance: PASS (isolated writers, draft PR, false closure blocked)")
