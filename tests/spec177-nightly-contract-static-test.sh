...
require 'python3 -m venv "$signing_venv"' "$WORKFLOW"
require '"$signing_venv/bin/python" scripts/release-trust-metadata.py' "$WORKFLOW"
require 'SHA256SUMS.txt.cosign.sig' "$WORKFLOW"
require '"focusa-${TAG}-${triple}"' "$WORKFLOW"
