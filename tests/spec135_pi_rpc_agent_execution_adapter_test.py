...
start_schema = json.loads(
    (BUNDLE / "json-schema/focusa.agent_execution_start.request.v1.json").read_text()
)
result_schema = json.loads(
    (BUNDLE / "json-schema/focusa.agent_execution_adapter_result.v1.json").read_text()
)
...
for marker in (
    ...
    'json!({"type":"abort"})',
    "terminate_pi_rpc_child",
    "WorkLoopScope",
    'permissions.allows("work-loop:write")',
    "ensure_writer_claim",
    "agent_execution_tool_result",
    "idempotent_replay",
