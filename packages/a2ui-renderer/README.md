...
The renderer accepts bounded A2UI snapshots/deltas, exposes canonical client
capabilities, and forwards actions to the caller for Focusa Operation Registry
validation. It is not an action authority and does not bypass capability,
